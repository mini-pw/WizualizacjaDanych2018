#' Creates the sidebar menu of the dashboard.
...
#' Creates the tab for the Overview option of the dashboard.
...
#' Creates the tab for the Analyzer option of the dashboard.
...
#' Creates a value box based on the team streak data.
#'
#' In case of the type of the streak we want to use a different
#' color. The color mappings are presented below:
#'
#' winning -> green
#' drawing -> light-blue
#' losing -> red
#'
#' @param selected_team_streak selected streak data to visualize
#'
