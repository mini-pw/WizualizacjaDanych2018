---
title: "Prognoza wynagrodzeñ na rok 2040"
output: html_notebook
---

Link do Ÿród³owego artyku³u: https://bezprawnik.pl/wzrost-wynagrodzen-w-polsce/
...
p1 <- ggplot(data = dat1, aes(x = kraj, y = wzrost_pensji)) +
  ...
  xlab("") + ylab("") +
  ggtitle("Przyrost œrednich wynagrodzeñ w ci¹gu najbli¿szych 20 lat")

p1 <- p1 + theme(plot.title = element_text(size = 14, hjust = 0.5))

countries2 <- c("Korea Po³udniowa", "USA", "Niemcy", "Francja", "UK", "Hiszpania", "W³ochy", "RPA", "Polska")
