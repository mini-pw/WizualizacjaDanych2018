...
##Wykres zmieniony w inkscape

![](./politicians_trust_with_logos.png )


Modyfikacje za pomocą inkscape:

* Zmiana czcionek
* wyszczuplenie i rozsunięcie słupków
* dodanie loga partii na tle koła z kolorowaniem o radialnym gradiencie nad każdym słupkiem
* przeniesienie wartości liczbowych nad koła z logami
